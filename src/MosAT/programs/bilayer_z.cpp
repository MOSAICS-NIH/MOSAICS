...
#include "MosAT/program_variables/pv_bilayer_z.h"           //This has the variables specific to the analysis program
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                           //
// This function computes the center for the lipid selection                                                 //
//                                                                                                           //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
double com_z(Trajectory &traj,system_variables &s,program_variables &p)
{   
    int i        = 0;   //standard variable used in loops
    double com_z = 0;   //z component of center of mass
    double M     = 0.0; //the sum of the atomic masses

    for(i=0; i<traj.target_leaflet.size(); i++) //loop over target leaflet atoms
    {   
        com_z = com_z + traj.mass[traj.target_leaflet[i]-1]*traj.r[traj.target_leaflet[i]-1][2];
        M     = M + traj.mass[traj.target_leaflet[i]-1];
    }
    if(M==0)
    {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                           //
// This function translates the system so the bilayer com_z lies on the target                               //
//                                                                                                           //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
void shift_atoms(Trajectory &traj,system_variables &s,program_variables &p)
{
    int i     = 0;                     //standard variable used in loops
    double dz = p.target_z - p.com_z;  //translate in z by this much
...
int main(int argc, const char * argv[]) 
{
    ...
    add_argument_mpi_d(argc,argv,"-z",      &p.target_z,                  "Target z for bilayer center (nm)",                            s.world_rank, s.cl_tags, nullptr,      1);
