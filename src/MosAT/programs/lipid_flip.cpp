...
int main(int argc, const char * argv[]) 
{
    ...
    add_argument_mpi_s(argc,argv,"-crd",    p.param_file_name,            "Selection card with target lipids (crd)",                             s.world_rank, nullptr,      1);
    add_argument_mpi_s(argc,argv,"-flip",   p.flip_file_name,             "Output file with z-coordinates data for each trajectory frame (dat)", s.world_rank, nullptr,      1);
