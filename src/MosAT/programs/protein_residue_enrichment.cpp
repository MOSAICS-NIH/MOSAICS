...
int main(int argc, const char * argv[]) 
{
    ...
    add_argument_mpi_s(argc,argv,"-enrich", p.enrich_file_name,           "Output file with percent enrichment for each protein residue (dat)",           s.world_rank, nullptr,      1);
    add_argument_mpi_s(argc,argv,"-e_pdb",  p.enrich_pdb_file_name,       "Output file with percent enrichment projected on the protein structure (pdb)", s.world_rank, nullptr,      1);
