...
int main(int argc, const char * argv[]) 
{
    ...
    add_argument_mpi_d(argc,argv,"-cutoff", &p.cutoff,                    "Percentage of box dimension that an atom must moved between frames to be counted as a jump (0 to 1)", s.world_rank, nullptr,      1);
