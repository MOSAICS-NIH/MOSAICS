...
int main(int argc, const char * argv[]) 
{
    ...
    add_argument_mpi_s(argc,argv,"-traj",   p.in_file_name,               "Input trajectory file with desired structure (xtc, trr, pdb, gro)",                  s.world_rank, nullptr,      1);
    add_argument_mpi_s(argc,argv,"-ref",    p.ref_file_name,              "Refference file (pdb, gro)",                                                         s.world_rank, nullptr,      1);
    add_argument_mpi_s(argc,argv,"-o",      p.out_file_name,              "Output trajectory file with desired structure and B values (xtc, trr, pdb, gro)",    s.world_rank, &p.b_print,   0);
    ...
    add_argument_mpi_s(argc,argv,"-traj_b", p.traj_2_file_name,           "Input trajectory file with desired B values (xtc, trr, pdb, gro)",                   s.world_rank, nullptr,      1);
