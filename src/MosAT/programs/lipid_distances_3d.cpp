...
int main(int argc, const char * argv[]) 
{
    ...
    add_argument_mpi_s(argc,argv,"-pairs",  p.e2e_pairs_file_name,        "Selection card defining target lipids and distances, etc. (crd)", s.world_rank, nullptr,      1);
    add_argument_mpi_s(argc,argv,"-ld",     p.e2e_file_name,              "Output data file with <dist> (dx)",                               s.world_rank, nullptr,      1);
