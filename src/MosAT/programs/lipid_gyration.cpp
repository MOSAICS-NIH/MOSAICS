...
int main(int argc, const char * argv[]) 
{
    ...
    add_argument_mpi_s(argc,argv,"-gyrate", p.gyration_file_name,         "Output file with the spatially resolved radius of gyration (dat)", s.world_rank, s.cl_tags, nullptr,      1);
