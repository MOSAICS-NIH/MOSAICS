...
int main(int argc, const char * argv[]) 
{
    ...
    add_argument_mpi_s(argc,argv,"-rho",    p.rho_file_name,              "Output file with the lipid density map (dx)",                 s.world_rank, s.cl_tags, nullptr,      1);
    add_argument_mpi_s(argc,argv,"-crd",    p.param_file_name,            "Name of the selection card (crd)",                            s.world_rank, s.cl_tags, nullptr,      1);
