...
int main(int argc, const char * argv[]) 
{
    ...
    add_argument_mpi_s(argc,argv,"-crd_1",  p.param_1_file_name,          "Selection card with lipid types, mapping, and tail atoms (crd)",  s.world_rank, nullptr,      1);
    add_argument_mpi_s(argc,argv,"-crd_2",  p.param_2_file_name,          "Selection card with opposing lipid types and atom ranking (crd)", s.world_rank, nullptr,      1);
    add_argument_mpi_s(argc,argv,"-digi",   p.digi_file_name,             "Output file with spatially resolved average rank (dat)",          s.world_rank, nullptr,      1);
