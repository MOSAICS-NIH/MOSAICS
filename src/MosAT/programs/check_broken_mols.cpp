...
#include "MosAT/program_variables/pv_check_broken_mols.h"   //This has the variables specific to the analysis program
...
int main(int argc, const char * argv[]) 
{
    ...
    s.program_name = "Check Broken Mols";
