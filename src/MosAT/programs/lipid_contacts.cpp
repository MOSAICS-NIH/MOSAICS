...
//                                                                                                           //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
double finalize_analysis(Trajectory &traj,system_variables &s,program_variables &p,Grid &lcont)
{
...
int main(int argc, const char * argv[]) 
{
    ...
    add_argument_mpi_s(argc,argv,"-lc",     p.lc_file_name,               "Output file with spatially resolved contacts count (dat)",    s.world_rank, nullptr,      1);
    ...
    add_argument_mpi_i(argc,argv,"-lip",    &p.count_lip,                 "Count lipids? (0:no 1:yes)",                                  s.world_rank, nullptr,      1);
    add_argument_mpi_i(argc,argv,"-prot",   &p.count_prot,                "Count protein? (0:no 1:yes)",                                 s.world_rank, nullptr,      1);
    add_argument_mpi_i(argc,argv,"-sol",    &p.count_sol,                 "Count sol? (0:no 1:yes)",                                     s.world_rank, nullptr,      1);
