...
int main(int argc, const char * argv[]) 
{
    ...
    add_argument_mpi_d(argc,argv,"-x",      &p.target[0],                 "Translate the x-component of center 3 to this coordinate (nm)", s.world_rank, nullptr,      1);
    add_argument_mpi_d(argc,argv,"-y",      &p.target[1],                 "Translate the y-component of center 3 to this coordinate (nm)", s.world_rank, nullptr,      1);
    add_argument_mpi_d(argc,argv,"-z",      &p.target[2],                 "Translate the z-component of center 3 to this coordinate (nm)", s.world_rank, nullptr,      1);
    add_argument_mpi_s(argc,argv,"-n1",     p.index1_file_name,           "Atom selection for center 1 (crd)",                             s.world_rank, nullptr,      1);
    add_argument_mpi_s(argc,argv,"-n2",     p.index2_file_name,           "Atom selection for center 2 (crd)",                             s.world_rank, nullptr,      1);
