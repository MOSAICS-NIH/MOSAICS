...
int main(int argc, const char * argv[]) 
{
    ...
    add_argument_mpi_s(argc,argv,"-crd",    p.param_file_name,            "Lipid types selection card (crd)",                            s.world_rank, s.cl_tags, nullptr,      1);
    add_argument_mpi_s(argc,argv,"-z",      p.z_file_name,                "Output file with <z-coords> (dat)",                           s.world_rank, s.cl_tags, nullptr,      1);
