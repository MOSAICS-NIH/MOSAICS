...
struct program_variables
{
    ...
    //b stamp stuff
    string traj_2_file_name;                      //Name of the second trajectory file
};
...
void initialize_program_variables(program_variables *p)
{
    ...
    p->program_description = p->program_description + "B Stamp is an analysis tool used for copying the B-factor from one pdb to another pdb.";
}
