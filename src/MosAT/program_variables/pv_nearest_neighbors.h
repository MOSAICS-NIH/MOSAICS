...
void initialize_program_variables(program_variables *p)
{
    ...
    p->program_description = "Nearest Neighbors is an analysis tool that probes the lipid packing density as a function of position in the XY plane. This is done by computing the number of lipid nearest-neighbors found within a user specified distance of the target lipid. This number is then projected onto the XY plane.";
 }
