...
struct program_variables
{
    ...
    string avg_file_name;                         //Name of the average coord output file
};
...
void initialize_program_variables(program_variables *p)
{
    ...
    p->program_description = "Mean Coords is a program that computes the time averaged coordinates of all atoms in the system.";
}
