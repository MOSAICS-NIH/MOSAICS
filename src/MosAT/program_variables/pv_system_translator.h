...
struct program_variables
{
    ...
    //system translator stuff
    string traj_2_file_name;                      //Name of the second trajectory file
    string ref_b_file_name;                       //Name of the second ref file
    string index_file_name;                       //Name of the index file for system 1
    string index_b_file_name;                     //Name of the index file for system b
    int b_fit;                                    //Fit traj to traj_b?   
};
...
void initialize_program_variables(program_variables *p)
{
    ...
    p->program_description = p->program_description + "System Translator is an analysis tools used for translating one system to match the position/orientation of another system. This is useful when attempting to compare grid data between different simulations.";
}
