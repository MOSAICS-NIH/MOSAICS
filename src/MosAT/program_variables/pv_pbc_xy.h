...
void initialize_program_variables(program_variables *p)
{
    ...
    p->program_description = "PBC_xy is a program designed to fix periodic boundary problems, specifically the jumping of lipids across the x or y axis. PBC_xy works by checking lipids in each frame for jumps by comparing the x and y coordinate to that from the previous frame. If the difference is too big (compared to the box size) a jump is assumed.";
}
