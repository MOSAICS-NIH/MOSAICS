...
void initialize_program_variables(program_variables *p)
{
    ...
    p->program_description = p->program_description + "Lipid Orientation is an analysis program that measures orientational preferences for the lipids. This ";
    ...
    p->program_description = p->program_description + " This time average vector is then characterized and the angle between the vector and z-axis is projected onto the XY plane.";
}
