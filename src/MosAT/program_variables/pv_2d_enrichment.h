...
struct program_variables
{
    ...
    int out_data_format;                          //Output data format? (0:matrix 1:vector)
...
void initialize_program_variables(program_variables *p)
{
    ...
    p->program_description = p->program_description + "2-D Enrichment is an analysis program that measures the enrichment factor for a given lipid type and ";
    p->program_description = p->program_description + "and projects this data onto the XY plane. ";
}
