...
void initialize_program_variables(program_variables *p)
{
    ...
    p->program_description = "P2 3d is a program that computes the rank 2 order parameter for lipids of a user specified type. This data is then averaged over a subset of the molecule and projected onto a 3d lattice.";
}
