...
void initialize_program_variables(program_variables *p)
{
    ...
    p->program_description = p->program_description + "APL is an analysis tool used for computing the area per lipid and projecting this information ont the xy plane ";
}
