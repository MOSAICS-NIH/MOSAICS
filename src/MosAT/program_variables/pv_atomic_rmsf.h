...
struct program_variables
{
    ...
    string rmsf_file_name;                        //Name of the output PDB file with RMSF data
...
void initialize_program_variables(program_variables *p)
{
    ...
    p->program_description = p->program_description + "Atomic RMSF is an alysis tool that measures the RMSF for each protein atom and projects this data onto the B-factor. ";
}
