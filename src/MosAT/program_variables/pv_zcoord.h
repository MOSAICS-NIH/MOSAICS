...
struct program_variables
{
    ...
    string z_file_name;                           //Name of the z-coord output file
...
void initialize_program_variables(program_variables *p)
{
    ...
    p->program_description = p->program_description +  "Z Coord is an analysis program that measures the average z-coordinate for atoms in ";
    p->program_description = p->program_description +  "the upper, lower, or both leaflets of a lipid bilayer and projects this data onto the XY plane.";
}
