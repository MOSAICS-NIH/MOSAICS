...
void initialize_program_variables(program_variables *p)
{
    ...
    p->program_description = p->program_description + "Lipid Distances is an analysis program that measures the distance between pairs of atoms within a target lipid or lipids. ";
    p->program_description = p->program_description + "These distances are then projected onto the XY plane and a time average is computed. ";
}
