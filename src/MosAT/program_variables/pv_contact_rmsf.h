...
struct program_variables
{
    ...
    string crmsf_file_name;                       //Name of the contact RMSF output file
    ...
    string selection_text_file_name;              //Name of selection text file used to refine protein selection 
