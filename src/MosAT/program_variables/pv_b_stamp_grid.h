...
struct program_variables
{
    ...
    //b stamp grid stuff
    string grid_file_name;                        //Name of the input grid data file 
    int out_data_format;                          //Format of the input grid data file
};
...
void initialize_program_variables(program_variables *p)
{
    ...
    p->program_description = p->program_description + "B Stamp Grid is an analysis tool that extracts grid data and applies it to the B-factor ";
    p->program_description = p->program_description + "of the mean lipid coordinates.";
}
