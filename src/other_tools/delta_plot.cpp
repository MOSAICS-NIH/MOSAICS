...
int main(int argc, const char * argv[]) 
{
    ...
    add_argument_s(argc,argv,"-d1"    , in_file_name_1,             "Input grid data file 1 (subtract me) (dat)"  , nullptr,      1);
    add_argument_s(argc,argv,"-d2"    , in_file_name_2,             "Input grid data file 2 (dat)"                , nullptr,      1);
    add_argument_s(argc,argv,"-o"     , out_file_name,              "Output grid data file with delta (dat) "     , nullptr,      1);
