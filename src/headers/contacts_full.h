...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                          //
// This is a class for working with contact profiles between two groups of atoms                            //
//                                                                                                          //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
class Contacts
{
    private:
        ...
        int    size_x;                                //how big is group 1
        int    size_y;                                //how big is group 2
    ...
    public:
        void init(string this_file_name,int this_size_y,int this_size_x);      //initializes the contact matrix
	...
	iv2d get_profile(int current_frame);                                   //read a frame from the contact matrix
        ...
        void get_profile_stamp(int current_frame,iv2d &contact_profile);       //read a frame from the contact matrix and increment count to existing profile
...
//                                                                                                           //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
void Contacts::init(string this_file_name,int this_size_y,int this_size_x)
{
...
iv2d Contacts::get_profile(int current_frame)
{
    ...
    iv2d contact_profile(size_y, iv1d(size_x,0));
    ...
    else
    {
        ...
        while(fgets(line, sizeof line, in_file) != NULL)
        {
            ...
            else
            {
                ...
                int atom_1 = atoi(my_string_1);
                int atom_2 = atoi(my_string_2);

                //set the contact in the matrix
                contact_profile[atom_1][atom_2] = 1;

                //store a record of the contact
                iv1d this_contact(2,0);    
                this_contact[0] = atom_1;
                this_contact[1] = atom_2;
...
//                                                                                                           //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
void Contacts::get_profile_stamp(int current_frame,iv2d &contact_profile)
{
    char line[200];           //used to read in a line of data
    char my_string_1[20];     //stores the current string
    char my_string_2[20];     //stores the current string
    ...
    else
    {
        ...
        while(fgets(line, sizeof line, in_file) != NULL)
        {
            ...
            {
                contact_profile[atoi(my_string_1)][atoi(my_string_2)] = contact_profile[atoi(my_string_1)][atoi(my_string_2)] + 1;
            }
        }
        fclose(in_file);
    }
...
void Contacts::clear_profile(iv2d &history,iv2d &contact_profile)
{
    ...
    {
        int atom_1 = history[i][0];
        int atom_2 = history[i][1];

        contact_profile[atom_1][atom_2] = 0;
    }
}
