...
set palette defined ( 0 "dark-red", 1 "#DC143C", 2 "#FFFFFF", 3 "#0000FF", 4 "#000000" )

set pm3d map
set pm3d explicit

set ylabel "Y (lattice point)"
set xlabel "X (lattice point)"
...
#label used when plotting masks for distance projection
set label 1 at  50, 416 ARG6 center rotate by 0 front tc rgb "black"

set xrang@ARG1
set yrang@ARG2
set cbrange@ARG3

splot ARG4 matrix with image pixels
