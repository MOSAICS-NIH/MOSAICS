...
set terminal png size 1200,1200 enhanced font "Arial,30"
set output ARG4
unset clip points
set clip one
unset clip two
...
f(x) = a*x
fit  [1:7800000] f(x) ARG3 u ($1) : ($@ARG5) via a
plot for [col=2:@ARG5-1] ARG3 using 1:col  with lines lt rgb "#D3D3D3",\
                      ARG3 using 1:@ARG5 with lines lt rgb "#000000",\
                      f(x) dashtype 2 lc rgb "#DC143C"
