...
plot for [col=2:ARG6] ARG3 every 1000::1 using 1:col with lines lt rgb "#D3D3D3" t "",\
     for [col=2:ARG7] ARG4 every 1000::1 using 1:col with lines lt rgb "#DC143C" t "",\
                     ARG3 every 1000::1 using 1:2   with lines lt rgb "#D3D3D3" t "Upper",\
                     ARG4 every 1000::1 using 1:2   with lines lt rgb "#DC143C" t "Lower",\
