...
#set scale so dlpc is red and popc is blue
#set palette defined ( 0 "dark-red", 316 "#DC143C", 633 "light-pink", 633.5 "#FFFFFF", 634 "light-blue", 995 "#0000FF", 1357 "#00008B" )
set palette defined ( -6 "white", -5 "#DC143C", -4 "#FFD700",-3 "chartreuse", -2 "#8A2BE2", -1 "#00FFFF", 0 "white", 1357 "black" )
...
#set colorbox lc rgb "white"
set border front lc rgb "white"

set label 1 at  160, 410 ARG6 center rotate by 0 front tc rgb "white" font ",40"
...
splot ARG4 u 1:2:($3) matrix with image pixels
